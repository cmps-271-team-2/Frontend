  ...
  return (
    <>
      ...
      <nav className="fixed top-0 right-8 h-screen z-[100] flex flex-col items-center justify-center gap-6">
        ...
        {/*category buttons (all, prof, cafeteria, study spot)*/}
        <div className="flex flex-col gap-4">
          {categories.map((cat) => (
            ...
            >
              ...
              <span className={`text-[10px] font-black uppercase mt-1 tracking-tighter ${activeCategory === cat.id ? "text-blue-600" : "text-black"}`}>
                {cat.label}
              </span>
            </button>
          ))}
